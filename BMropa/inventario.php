...
<div class="contenedor">
    <div class="container">
        ...
        <div class="d-flex mb-3">
            ...
            <button type="button" class="btn btn-secondary ms-2" onclick="clearFields()">Limpiar</button>
        </div>
...
function openEditModal(id_ropa) {
    fetch(`ControladorInventario.php?tipo=obtener&id_ropa=${id_ropa}`)
        ...
        .then(data => {
            ...
            document.getElementById("talla").value = data.id_talla;  
...
function clearFields() {
    ...
    const selects = document.querySelectorAll('.form-select.me-2');
    ...
    document.getElementById("categoria").value = 'Seleccionar Categoria';
    document.getElementById("marca").value = 'Seleccionar Marca';
    document.getElementById("talla").value = 'Seleccionar Talla';
...
function deleteProduct(id_ropa) {
    if (confirm("¿Estás seguro de que deseas eliminar esta prenda?")) {
        fetch(`ControladorInventario.php?tipo=eliminar&id_ropa=${id_ropa}`)
