...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;700&family=Playfair+Display:ital,wght@0,400..900;1,400..900&family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet">
...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="javascript:void(0);" onclick="mostrarCarrito()"><i class="fas fa-shopping-cart"></i> Carrito <span id="iconoCarrito" style="display: none;"></span></a></li>
    ...
    <div id="chatbox">
      <div id="chat-content">
        ...
        <select id="opciones" name="opciones">
            <option value="opcion1">Envios</option>
            <option value="opcion2">Cancelar Pedido</option>
            <option value="opcion3">Ofertas</option>
        </select>
      </div>
      
      <input type="text" id="user-input" placeholder="Escribe aquí..." />
      <button id="INFO" onclick="sendMessage()">Enviar</button>
    </div>
